...
Inside a committed envelope, `source` is the authoritative aggregate identity.
...
An event whose optional aggregate identity stamps are absent takes its aggregate identity
from the envelope.
