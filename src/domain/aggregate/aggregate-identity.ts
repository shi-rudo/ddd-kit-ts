/**
 * The identity of one aggregate instance, as a value.
 *
 ...
 * persistence keys and orphans checkpoints unless the stored aggregate
 * identities are migrated. When bounded contexts share infrastructure and
 * reuse a domain name, qualify it at the source (`sales.order`,
 * `fulfillment.order`). The kit
