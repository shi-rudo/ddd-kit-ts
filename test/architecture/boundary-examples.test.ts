...
const exampleUrls = {
	command: new URL(
		"../../src/application/cqrs/command/command.ts",
		import.meta.url,
	),
	query: new URL("../../src/application/cqrs/query/query.ts", import.meta.url),
	orderPlacement: new URL(
		"../../examples/order-placement/order-placement-example.ts",
		import.meta.url,
	),
